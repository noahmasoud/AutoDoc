...
from .correlation import generate_request_id, set_request_context
        ...
        def wrapper(*args, **kwargs):
            ...
            for arg in args:
                if hasattr(arg, "method") and hasattr(arg, "path"):
                    ...
                    request_info.update(
                        {
                            ...
                            "user_agent": getattr(arg, "headers", {}).get(
                                "User-Agent",
                                "unknown",
                            ),
                        },
                    ...
                    if include_user:
                        user_id = getattr(arg, "user_id", None) or getattr(
                            arg,
                            "user",
                            {},
                        ).get("id")
            ...
            with log_request_context(
                ...
                try:
                    ...
                    if include_timing and start_time:
                        ...
                        ctx.log_event(
                            "api_call_error",
                            f"API call failed: {func.__name__} - {e!s}",
                            duration_ms=round(duration * 1000, 2),
...
def fastapi_integration_example():
    ...
    app = FastAPI()
    APILoggingMiddleware("autodoc.api")
